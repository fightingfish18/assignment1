...
<body>
	<div id="contentArea">	
		...
		<div class="bkg">
			<h1>Menu</h1>
			<h2>All pizzas can be customized--add a few ingredients, or take a few off--for an extra $2.</h2>
			<h2>Pizzas:</h2>
			<dl>
				<dt>All our pizzas are made with hand-thrown thin crust, baked in real wood ovens. Choose from one of these sizes:</dt>
					<dd>Small (12")</dd>
					<dd>Medium (14")</dd>
					<dd>Large (17")</dd>
				...
				<dt>Drinks:</dt>
					<dd>Coke, Diet Coke, Sprite, Root Beer, or Irn Bru by the can ($4)</dd>
					<dd>Rainier Beer by the can ($4)</dd>
					<dd>House Red Wine by the glass or bottle ($10/$40)</dd>

				<dt>Dessert:</dt>
					<dd>Chocolate Gelato ($8)</dd>
					<dd>Lemon Sorbet ($7)</dd>
					<dd>Ricotta Cheese Cake ($10)</dd>
			</dl>
			<?php footing() ?>
		</div>
	</div>
